...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-[210px] bg-surface border-right border-border flex flex-col z-50">
      {/* Logo Section */}
      <div className="p-5 border-bottom border-border-light flex items-center gap-3">
